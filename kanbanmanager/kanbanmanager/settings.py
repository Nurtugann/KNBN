...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # общий каталог templates/
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# 8) База данных (SQLite по умолчанию)
DATABASES = {
    'default': {
...
# WhiteNoise позволяет отдавать собранную статику
# MIDDLEWARE уже содержит 'whitenoise.middleware.WhiteNoiseMiddleware'
